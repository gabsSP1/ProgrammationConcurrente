...
TP_MULTITACHE : Mere.o GestionClavier.o Sortie.o
	g++ -L/shares/public/tp/tp-multitache/ -o tp-multitache/Parking Mere.o GestionClavier.o Sortie.o -std=c++11 -ltp -lncurses -ltcl
